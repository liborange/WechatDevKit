...
public class HttpsClient
{
	 ...
	 * 进行HTTPS请求。
	 * 
	 * @param requestMethod 请求方式，可为GET或POST
	 * @param url 请求地址
	 * @param body 请求内容，可为空。
	 * @return 应答内容
	 */
	public static String request(RequestMethod requestMethod, String url, String body)
	{
		...
		try
		{
			...
			if (body != null) 
			{
				...
				ops.write(body.getBytes(Config.UTF));
				ops.flush();
			}
			
			ips = conn.getInputStream();
			reader = new BufferedReader(new InputStreamReader(ips, Config.UTF));
